  ...
  return (
    <section>
      <div className={`text-white z-10 select-none`}>
        ...
        <p className="w-full">The Sun is a giant, nearly perfect sphere of hot plasma, and its core reaches temperatures of about 15 million degrees Celsius (27 million degrees Fahrenheit). This intense heat drives nuclear fusion, where hydrogen atoms fuse to form helium, releasing massive amounts of energy that powers the Sun and provides light and warmth to our solar system.</p>
